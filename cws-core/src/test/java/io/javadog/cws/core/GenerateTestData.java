...
public final class GenerateTestData {
    ...
    public String prepareTestData() {
        ...
        createAndAppendMember(builder, DatabaseSetup.ADMIN_ID, Constants.ADMIN_ACCOUNT, keyPair, ',');
        final CWSKeyPair keyPair1 = crypto.generateAsymmetricKey(settings.getAsymmetricAlgorithm());
        createAndAppendMember(builder, DatabaseSetup.MEMBER_1_ID, DatabaseSetup.MEMBER_1, keyPair1, ',');
        final CWSKeyPair keyPair2 = crypto.generateAsymmetricKey(settings.getAsymmetricAlgorithm());
        createAndAppendMember(builder, DatabaseSetup.MEMBER_2_ID, DatabaseSetup.MEMBER_2, keyPair2, ',');
        final CWSKeyPair keyPair3 = crypto.generateAsymmetricKey(settings.getAsymmetricAlgorithm());
        createAndAppendMember(builder, DatabaseSetup.MEMBER_3_ID, DatabaseSetup.MEMBER_3, keyPair3, ',');
        final CWSKeyPair keyPair4 = crypto.generateAsymmetricKey(settings.getAsymmetricAlgorithm());
        createAndAppendMember(builder, DatabaseSetup.MEMBER_4_ID, DatabaseSetup.MEMBER_4, keyPair4, ',');
        final CWSKeyPair keyPair5 = crypto.generateAsymmetricKey(settings.getAsymmetricAlgorithm());
        createAndAppendMember(builder, DatabaseSetup.MEMBER_5_ID, DatabaseSetup.MEMBER_5, keyPair5, ';');
