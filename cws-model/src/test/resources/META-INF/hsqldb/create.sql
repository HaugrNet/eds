...
CREATE TABLE keys (
  id               INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 1 NO CYCLE),
  algorithm        VARCHAR(256) DEFAULT 'AES',
  cipher_mode      VARCHAR(256) DEFAULT 'CBC',
  padding          VARCHAR(256) DEFAULT 'PKCS5Padding',
...
CREATE TABLE objects (
  ...
  CONSTRAINT object_datatype_fk             FOREIGN KEY (datatype_id) REFERENCES datatypes (id),
  ...
  CONSTRAINT object_notnull_type_id         CHECK (datatype_id IS NOT NULL),
