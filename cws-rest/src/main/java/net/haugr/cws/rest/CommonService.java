...
final class CommonService {
    ...
    /**
     * <p>This method will invoke the CWS Logic, using Reflection to find the
     ...
     * errors in CWS are properly converted to a ReturnCode plus Message, and
     * returned to the recipient for proper error handling.</p>
     *
     * <p>As CWS is not a HTTP Service, but rather an application, all
     ...
     *
     * @param settings     Current CWS Settings, to read the LOCALE from
     * @param bean         The CWS Bean to invoke
     * @param invokeMethod The method to invoke on the CWS Bean
     * @param request      The Request Object
     * @param logAction    The Action information to be logged
     * @return Response from CWS or error response if request failed
     */
     ...
     *
     * @param bean         CWS Bean to find the method in
     * @param invokeMethod Method to find
     * @return Found method
     * @throws CWSException if no method was found
     */
